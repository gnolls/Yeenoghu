...
<!-- <div id="wrapper"> -->
<div style="width:<?php echo (isset($this->_tpldata['DEFINE']['.']['MG_GLOBAL_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['MG_GLOBAL_WIDTH'] : ''; ?>;clear:both;margin: 0 auto;">
...
<tr>
<td height="150" align="left" valign="middle"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>"><?php echo (isset($this->_rootref['SITE_LOGO_IMG'])) ? $this->_rootref['SITE_LOGO_IMG'] : ''; ?></a></td>
<td align="center" valign="middle"><h1><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></h1><span class="gen"><?php echo (isset($this->_rootref['SITE_DESCRIPTION'])) ? $this->_rootref['SITE_DESCRIPTION'] : ''; ?></span></td>
<td align="right" valign="top">&nbsp;</td>
</tr>
</table>
</div>

<?php $this->_tpl_include('menu_block.html'); if ($this->_rootref['S_BOARD_DISABLED'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?><span style="color:#a7942a;"><?php echo ((isset($this->_rootref['L_BOARD_DISABLED'])) ? $this->_rootref['L_BOARD_DISABLED'] : ((isset($user->lang['BOARD_DISABLED'])) ? $user->lang['BOARD_DISABLED'] : '{ BOARD_DISABLED }')); ?></span><?php } ?>
